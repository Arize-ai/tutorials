...
| 4:00–6:00 | Open the AX project and inspect `receipt.extract` | Show fixture ID, scenario, model, output, expected data, and selectable image URL. |
...
| 9:00–11:00 | Re-run with injected error | The changed merchant and total should receive `not_grounded`. |
